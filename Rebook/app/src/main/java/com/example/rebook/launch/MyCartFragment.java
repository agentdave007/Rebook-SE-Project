...
public class MyCartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cartItemModelList.add(new CartItemModel(0,R.drawable.motivation_book,"The Growth Mindset",0,"Rs. 300/-","Rs. 500",1,1,2));
        cartItemModelList.add(new CartItemModel(0,R.drawable.dmbs,"Database-DBMS",2,"Rs. 300/-","Rs. 500",1,0,0));
        cartItemModelList.add(new CartItemModel(1,"Price (3 items )"," Rs. 1500","muft","Rs. 900","Rs.600"));
