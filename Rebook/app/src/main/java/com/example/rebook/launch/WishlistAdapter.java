...
public class WishlistAdapter extends RecyclerView.Adapter<WishlistAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        viewHolder.setData(resource,title,freeCoupen,rating,totalRating,productPrice,cuttedPrice,paymentMethod);
    }
        ...
        private void setData(int resource, String title, int freeCoupensNo, String averageRate, int totalRatingsNo, String price, String cuttedPriceValue, String payMethod) {
            ...
            deleteBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(itemView.getContext(), "Deleted demo", Toast.LENGTH_SHORT).show();
                }
            });
