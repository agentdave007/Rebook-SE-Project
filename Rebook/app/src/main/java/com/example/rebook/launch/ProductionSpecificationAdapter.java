...
public class ProductionSpecificationAdapter extends RecyclerView.Adapter<ProductionSpecificationAdapter.ViewHolder> {

    private List<ProductSpecificationModel> productSpecificationModelList;

    public ProductionSpecificationAdapter(List<ProductSpecificationModel> productSpecificationModelList) {
    ...
    @NonNull
    @Override
    public ProductionSpecificationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ProductionSpecificationAdapter.ViewHolder viewHolder, int position) {
        switch (productSpecificationModelList.get(position).getType()) {
            case ProductSpecificationModel.SPECIFICATION_TITLE:
